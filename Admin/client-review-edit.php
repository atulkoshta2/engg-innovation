                        ...
                        <div class="sk-spinner sk-spinner-double-bounce">
                            ...
                            <div class="modal-header">
                                ...
                                <h5 class="text-capitalize float-right">
                                    <a href="client-review?<?php echo $enc->enc1($fetch['projectID']); ?>" class="btn btn-outline-secondary btn-sm"> &#9664; back </a>
                                </h5>
                            </div>
                            <form role="form" id="editForm" method="post" onsubmit="event.preventDefault(); edit_client_review('<?= $enc->enc1($fetch['projectID']) ?>');" enctype="multipart/form-data">
                                    ...
                                    <div class="table-responsive table-sm">
                                        <table class="table mb-0 table-borderless">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($CLIENT_REVIEW->fetch() as $Value) {
...
function edit_client_review(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            window.setTimeout(function (){
                window.location.href='client-review?'+id;
            }, 2000);
        },
