...
<div class="modal inmodal fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content loader-parent">
            ...
            <form role="form" id="myForm" method="post" onsubmit="event.preventDefault(); create_project_detail();" enctype="multipart/form-data">
                ...
                <?php $enc->token(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" id="image_file" name="image" accept="image/gif" />
                    </div>
                    <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="breadcrumb-main">
                            ...
                            <h4 class="text-capitalize breadcrumb-title">Features Detail</h4>

                            <div class="breadcrumb-action justify-content-center flex-wrap">

                                <div class="action-btn">
                                <?php if(count($PROJECT_DETAIL->fetch_where(['projectID' => $id]))  <= 3) { ?> 
                                    <a href="javascript:void(0);" class="btn btn-sm btn-primary btn-add" onclick="add_project_detail();">
                                    ...
                                    <div class="table-responsive table-sm">
                                        <table class="table mb-0 table-borderless">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($PROJECT_DETAIL->fetch_where(['projectID' => $id]) as $Value) {
...
function create_project_detail(e) {
