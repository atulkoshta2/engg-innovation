...
{
$message12345["result"] = "success"; 
		 echo json_encode($message12345);
  ...
  $results = mysqli_query($conn,$sql);
		...
		$ww = date('Y-m-d'); 
         ...
         $ab = date("h:i")."\n";
	      ...
	      $sql = "INSERT INTO `message` (`sender_id`,`reciver_id`,`group_id`,`message`,`message_image`,`date`,`time`) VALUES ('$sender_id','$reciver_id','$group_id','$msg','','$date1234','$ab')";
		  ...
		  $mysqli_insert_id =  mysqli_insert_id($conn); 
			...
			$message_dow["result"] = "unsuccess"; 
			
			}else
			{
		 	
		 	$message_dow["m_id"]  = $mysqli_insert_id; 
			$message_dow["result"] = "success"; 	  
			}     
			 
			 json_encode($message_dow);   
	        // die; 
