...
//--------------------------------start----------------------------------------------------------
  ...
  
   {
		...
		$msg= $_REQUEST['meeting_title'];
              $meeting_address=$_REQUEST['meeting_address'];
  ...
  $results = mysqli_query($conn,$sql);
		...
		$ww = date('Y-m-d'); 
         ...
         $ab = date("h:i")."\n";
	      ...
	      $sql = "INSERT INTO `message` (`sender_id`,`reciver_id`,`group_id`,`meeting_title`,`meeting_address`,`meeting_time`,`date`,`time`) VALUES ('$sender_id','$reciver_id','$group_id','$msg','$meeting_address','$meeting_time','$date1234','$ab')";
