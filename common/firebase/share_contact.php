  ...
  $results = mysqli_query($conn,$sql);
		...
		$ww = date('Y-m-d'); 
         ...
         $ab = date("h:i")."\n";
	      ...
	      $sql = "INSERT INTO `message` (`sender_id`,`reciver_id`,`group_id`,`contact_name`,`contact_number`,`date`,`time`) VALUES ('$sender_id','$reciver_id','$group_id','$msg','$contact_number','$date1234','$ab')";
